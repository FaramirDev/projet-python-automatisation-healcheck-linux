# Sentinel-Health : Audit Systeme Linux
...
**Vérification** de l'état des **services** **critiques** (SSH, Pare-feu, etc.).
...
---
---
## •  --- Guide de Réponse aux Incidents (Incident Response) -----------------
...
### --- Étape 3 : Audit des accès et connexions actives -------
